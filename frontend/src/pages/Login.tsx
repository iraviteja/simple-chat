    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-purple-700 flex relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 lg:p-16 relative z-10 bg-white/5 backdrop-blur-sm">
        ...
        <div className="flex items-center mb-10 animate-fade-in-left">
          ...
          <h1 className="text-4xl font-bold text-white drop-shadow-lg">SimpleChat</h1>
        </div>

        {/* Hero Content */}
        <div className="text-center animate-fade-in-left max-w-lg" style={{ animationDelay: '0.2s' }}>
          <h2 className="text-5xl font-extrabold text-white mb-6 leading-tight drop-shadow-xl">
            Connect & Communicate
          </h2>
          <p className="text-xl text-white/80 mb-10 leading-relaxed">
            Experience seamless conversations with our next-generation chat platform
          </p>
      ...
      <div className="flex-1 bg-white/95 backdrop-blur-sm flex items-center justify-center p-8 lg:p-16 relative z-10">
        <div className="w-full max-w-md animate-fade-in-right">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="text-right mt-2">
                <Link to="#" className="text-indigo-600 text-sm font-medium hover:text-indigo-800 transition-colors duration-200">
                  Forgot Password?
                </Link>
              </div>
            </div>
          ...
          <div className="flex gap-3">
            <button className="flex-1 flex items-center justify-center gap-2 py-3 border-2 border-gray-200 rounded-xl bg-white font-medium text-sm transition-all duration-300 hover:border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-4 focus:ring-gray-100">
